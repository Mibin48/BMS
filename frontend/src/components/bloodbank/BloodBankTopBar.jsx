...
import { Bell, ChevronDown, Droplets, Search, Command, Settings, LogOut } from 'lucide-react';
...
export default function BloodBankTopBar({ title, page }) {
    ...
    const displayName = user?.name || mockBloodBank.admin_name;
            ...
            <div style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
                            ...
                            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: 'rgba(255,255,255,0.3)', letterSpacing: '0.05em' }}>BLOOD BANK</span>
                            <span style={{ color: 'rgba(255,255,255,0.15)', fontSize: 10 }}>/</span>
                    ...
                    <div style={{ position: 'relative', marginLeft: 12 }} className="hidden xl:block">
                        ...
                        <input 
                            type="text" 
                            placeholder="Find donor or inventory..." 
                            style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                        ...
                        >
                            <Droplets size={16} /> Record Donation
                        </button>
                        ...
                        <div style={{ 
                            ...
                            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: '#22c55e', fontWeight: 800, letterSpacing: '0.05em' }}>{totalUnits} UNITS LIVE</span>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 20, position: 'relative' }} ref={dropdownRef}>
                        ...
                        >
                            <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column' }} className="hidden md:flex">
                                ...
                                <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: 'rgba(255,255,255,0.4)', letterSpacing: '0.05em' }}>{mockBloodBank.city.toUpperCase()}</span>
                            </div>
                            <div style={{ 
                            ...
                            {isOpen && (
                                ...
                                >
                                    <div style={{ padding: '12px 14px', borderBottom: '1px solid rgba(255,255,255,0.04)', marginBottom: 4 }}>
                                        ...
                                        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: 'rgba(255,255,255,0.4)', marginTop: 2 }}>{user?.email || 'bloodbank@hema.com'}</div>
                                    </div>
                                    ...
                                    <div 
                                        ...
                                        onClick={() => { navigate('/bloodbank/profile'); setIsOpen(false); }}

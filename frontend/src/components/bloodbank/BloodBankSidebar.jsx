...
import {
    ...
    CreditCard, User, Settings, LogOut, Calendar, MapPin
} from 'lucide-react';
...
const NAV = [
    {
        section: 'OVERVIEW', items: [
            ...
            { to: '/bloodbank/appointments', icon: Calendar, label: 'Appointments' },
            { to: '/bloodbank/camps', icon: MapPin, label: 'Donation Camps' },
            { to: '/bloodbank/notifications', icon: Bell, label: 'Notifications' },
        ]
    },
    {
    ...
    },
    {
        section: 'ACCOUNT', items: [
            { to: '/bloodbank/profile', icon: Settings, label: 'Settings & Profile' },
        ]
    },
];
    ...
    const handleLogout = async () => {
        ...
        >
            ...
            <div style={{ padding: '20px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)', flexShrink: 0 }}>
                ...
                <div style={{ fontFamily: 'var(--font-sub)', fontWeight: 700, fontSize: 15, color: '#fff', marginBottom: 3 }}>{user?.name || mockBloodBank.bank_name}</div>
